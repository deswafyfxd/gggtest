...
curl -L -o /app/partial_sessions.zip "https://tvkkdata.tvkishorkumardata.workers.dev/download.aspx?file=Y5ypRtUko7wRfW1kfZxt6Y4qGi13ru%2BUmBnJoc%2FDhBh8AbJUWA8wP8IBzMHwiK49&expiry=E0nPuvTYKldc7LAovpWF%2Fw%3D%3D&mac=0cd81adeba2362a95c7dd07bc6b2fefa89d776d965f6f2394b8af0b60c726cbe"
...
chmod 777 /app/partial_sessions.zip

sleep 15

# Check if the zip file exists and unzip it directly to /app/sessions
if [ -f /app/partial_sessions.zip ]; then
    unzip -o /app/partial_sessions.zip -d /app/
    echo "Session data unzipped successfully."
